...
-- Resize
local Resize = CreateObject("ImageButton", {
    Name = "Resize", 
    Parent = FrameMain, 
    AnchorPoint = Vector2.new(0.5, 1), 
    BackgroundColor3 = Color3.fromRGB(255, 255, 255), 
    BackgroundTransparency = 1, 
    Position = UDim2.new(0.5, 0, 1, 0),  -- Position at the bottom center
    Size = UDim2.new(0, 20, 0, 20),  -- Resize button size
    AutoButtonColor = false, 
    Image = "http://www.roblox.com/asset/?id=5172066892", 
